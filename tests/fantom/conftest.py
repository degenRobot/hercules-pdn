...
USDC_WHALE = '0xe7E90f5a767406efF87Fdad7EB07ef407922EC1D'
WFTM_WHALE = '0xe7E90f5a767406efF87Fdad7EB07ef407922EC1D'
LQDR = '0x10b620b2dbAC4Faa7D7FFD71Da486f5D44cd86f9'
LQDR_FARM = '0x6e2ad6527901c9664f016466b8DA1357a004db0f'
...
CONFIG = {
    'USDCWFTMLQDR': {
        'token': USDC,
        'whale': USDC_WHALE,
        'shortWhale' : WFTM_WHALE,
        'deposit': 1e6,
        'harvest_token': LQDR,
        'harvest_token_price': LQDR_PRICE * 1e-12,
        'harvest_token_whale': '0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce',
    ...
    'WETHWFTMLQDR': {
        'token': WETH,
        'whale': '0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce',
        'shortWhale' : WFTM_WHALE,
        'deposit': 1e6,
        'harvest_token': LQDR,
        'harvest_token_price': (LQDR_PRICE) / 2000,
        'harvest_token_whale': '0x20dd72Ed959b6147912C2e529F0a0C651c33c9ce',
        'lp_token': '0xf0702249F4D3A25cD3DED7859a165693685Ab577',
        'lp_whale': '0x2b2929E785374c651a81A63878Ab22742656DcDd',
        'lp_farm': LQDR_FARM,
        'pid': 15,
        'router': SPOOKY_ROUTER,
...
def strategy_contract():
    yield  project.CoreStrategyProject.WETHWFTMLQDR
...
def amount(accounts, token, user, conf, whale):
    ...
    amount = min(amount, int(0.1*token.balanceOf(whale)))
...
@pytest.fixture
def deployed_vault_large_deposit(
    chain,
    accounts,
    gov,
    token,
...
@pytest.fixture
def strategy_mock_oracle(token, amount, user, strategist, keeper, vault, strategy_contract, gov, MockAaveOracle,chain):
    ...
    oracle = MockAaveOracle.deploy(ORACLE, {'from': admin})
    """
