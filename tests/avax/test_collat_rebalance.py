...
def test_collat_rebalance(chain, accounts, token, deployed_vault, strategy, user, conf, gov, lp_token, lp_whale, lp_farm, lp_price, pid, collatTarget, collatLimit):
    # set low collateral and rebalance
    # assert True == False
    target = 2000
    strategy.setCollateralThresholds(target-500, target, target+500, collatLimit)
...
def test_set_collat_thresholds(chain, accounts, token, deployed_vault, strategy, user, conf, gov, lp_token, lp_whale, lp_farm, lp_price, pid, collatTarget, collatLimit):
...
def test_large_collat_rebalance_with_low_debt(chain, accounts, token, deployed_vault, strategy, user, conf, gov, lp_token, lp_whale, lp_farm, lp_price, pid, collatTarget, collatLimit):
    # set low collateral and rebalance
    target = 2000
    strategy.setCollateralThresholds(target-500, target, target+500, collatLimit)
...
def test_typical_rebalance_with_low_debt(chain, accounts, token, deployed_vault, strategy, user, conf, gov, lp_token, lp_whale, lp_farm, lp_price, pid, collatTarget, collatLimit):
    # set low collateral to 52%
    target = collatTarget - 800
...
# this is a typical collat rebalance ~10% rebalance
def test_typical_collat_rebalance_with_high_debt(chain, accounts, token, deployed_vault, strategy, user, conf, gov, lp_token, lp_whale, lp_farm, lp_price, pid, collatTarget, collatLimit):
    # set high collateral and rebalance
    target = collatTarget + 800
    strategy.setCollateralThresholds(target-500, target, target+500, collatLimit)
    strategy.rebalanceCollateral()
