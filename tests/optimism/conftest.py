...
ZIP_FARM = '0x1e2F8e5f94f366eF5Dc041233c0738b1c1C2Cb0c'
...
ZIP = '0xFA436399d0458Dbe8aB890c3441256E3E09022a8'
...
CONFIG = {
    'USDCWETHZIP': {
        'token': USDC,
        'whale': USDC_WHALE,
        'shortWhale' : '0xaa30D6bba6285d0585722e2440Ff89E23EF68864',
        'deposit': 1e6,
        'harvest_token': ZIP,
        'harvest_token_price': ZIP_PRICE * 1e-12,
        'harvest_token_whale': '0xeA739CA4c6076dBF7f9BeAB03f73F2c802540296',
        'lp_token': '0x1A981dAa7967C66C3356Ad044979BC82E4a478b9',
        'lp_whale': '0x6eaAb14c486C555B83B9ca748e8d368F23413955',
        'lp_farm': ZIP_FARM,
        'pid': 0,
        'router': ZIP_ROUTER,
    },
    ...
    'USDCWETHVELO': {
        ...
        'deposit': 1e6,
        'harvest_token': VELO,
        'harvest_token_price': VELO_PRICE * 1e-12,
        'harvest_token_whale': '0x9c7305eb78a432ced5C4D14Cac27E8Ed569A2e26',
        'lp_token': '0x79c912FEF520be002c2B6e57EC4324e260f38E50',
        'lp_whale': '0xE2CEc8aB811B648bA7B1691Ce08d5E800Dd0a60a',
        'lp_farm': '0xE2CEc8aB811B648bA7B1691Ce08d5E800Dd0a60a',
        'pid': 0,
        'router': VELO_ROUTER,
    },
...
def strategy_contract():
    yield  project.CoreStrategyProject.USDCWETHVELO
...
def lp_farm(conf):
    ...
    if conf['router'] == '0xa132DAB612dB5cB9fC9Ac426A0Cc215A3423F9c9' :
        yield interface.IGauge(conf['lp_farm'])
    else: 
        yield interface.IZipRewards(conf['lp_farm'])
